...
date: "Due Friday, November 9th, 2018 (6:30pm)"
output: 
  html_document:
    toc:  true
    toc_float:  true
...
+ Fill in the google form [here](https://docs.google.com/spreadsheets/d/1aQz3U5JttqTyb3bqLXkcdiQ9lWydqx_kFzJR-eqBm0s/edit#gid=0) with the name of your dataset. Please avoid using the same dataset as other groups. Consider changing your dataset if there are clashes.
